...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/23 11:52:03 by mokon             #+#    #+#             */
/*   Updated: 2025/07/23 11:52:03 by mokon            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*single_philo(void *arg)
{
	...
	long_setter(&philo->philo_mutex, &philo->last_meal_time,
...
static void	eat(t_philo *philo)
{
	...
	if (philo->table->meals_limit_count > 0
		&& philo->meals_eaten == philo->table->meals_limit_count)
...
void	dinner_start(t_table *table)
{
	...
	if (table->philo_nbr == 0)
		...
		thread_handle(&table->philos[0].thread, "CREATE",
			single_philo, &table->philos[0]);
	else
	{
		i = -1;
		while (++i < table->philo_nbr)
			thread_handle(&table->philos[i].thread, "CREATE",
